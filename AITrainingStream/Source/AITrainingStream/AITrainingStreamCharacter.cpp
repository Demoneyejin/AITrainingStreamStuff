...
//////////////////////////////////////////////////////////////////////////
// AAITrainingStreamCharacter

AAITrainingStreamCharacter::AAITrainingStreamCharacter()
{
...
void AAITrainingStreamCharacter::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AAITrainingStreamCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void AAITrainingStreamCharacter::MoveForward(float Value)
{
...
void AAITrainingStreamCharacter::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) )
	{
